...
Define el listado de esquemas (catálogo) del sitio: se construye dinámicamente a partir de un archivo de datos externo, se renderiza como tarjetas, admite búsqueda por nombre y permite copiar el código de cada esquema al portapapeles.
